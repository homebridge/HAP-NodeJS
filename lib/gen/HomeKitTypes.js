...
/**
 * Characteristic "Alarm Current State"
 */

Characteristic.AlarmCurrentState = function() {
  Characteristic.call(this, 'Alarm Current State', '00000066-0000-1000-8000-0026BB765291');
  this.format = 'uint8';
  this.readable = true;
  this.supportsEventNotification = true;
  this.value = this.getDefaultValue();
...
inherits(Characteristic.AlarmCurrentState, Characteristic);

// The value property of AlarmCurrentState must be one of the following:
Characteristic.AlarmCurrentState.ARMED = 0;
Characteristic.AlarmCurrentState.DISARMED = 1;
Characteristic.AlarmCurrentState.HOLD = 2;

/**
 * Characteristic "Alarm Target State"
 */

Characteristic.AlarmTargetState = function() {
  Characteristic.call(this, 'Alarm Target State', '00000067-0000-1000-8000-0026BB765291');
  this.format = 'uint8';
  this.readable = true;
  this.writable = true;
  this.supportsEventNotification = true;
...
inherits(Characteristic.AlarmTargetState, Characteristic);

// The value property of AlarmTargetState must be one of the following:
Characteristic.AlarmTargetState.STAY_ARM = 0;
Characteristic.AlarmTargetState.AWAY_ARM = 1;
Characteristic.AlarmTargetState.NIGHT_ARM = 2;
Characteristic.AlarmTargetState.DISARM = 3;
...
Characteristic.PositionState.CLOSING = 0;
Characteristic.PositionState.OPENING = 1;
...
Service.AirQualitySensor = function(displayName) {
  ...
  // Required Characteristics
  this.addCharacteristic(new Characteristic.AirParticulateDensity());
  this.addCharacteristic(new Characteristic.AirParticulateSize());
...
Service.AlarmSystem = function(displayName) {
  Service.call(this, displayName, '0000007E-0000-1000-8000-0026BB765291');
  this.name = "Alarm System";

  // Required Characteristics
  this.addCharacteristic(new Characteristic.AlarmCurrentState());
  this.addCharacteristic(new Characteristic.AlarmTargetState());
...
inherits(Service.AlarmSystem, Service);
