...
// Hue API Linkage
HAPServer.prototype._handleHueApi = function(request, response, session, events, requestData) {
  hue.handleHueApi(this, request, response, session, events, requestData);
}
