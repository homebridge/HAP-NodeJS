...
StreamController.prototype._generateSetupResponse = function(identifier, response, callback) {
  ...
  var videoSRTP = Buffer([0x01, 0x01, 0x02, 0x02, 0x00, 0x03, 0x00]);
  var audioSRTP = Buffer([0x01, 0x01, 0x02, 0x02, 0x00, 0x03, 0x00]);
  ...
  if (self.requireProxy) {
    ...
    ipAddress = Buffer(currentAddress);
