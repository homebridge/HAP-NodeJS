...
StreamController.prototype._handleStartStream = function(objects, session, reconfigure, callback) {
  ...
  if(objects[StreamController.SelectedStreamConfigurationTypes.AUDIO]) {
    ...
    audioInfo["codec"] = codec.readUInt8(0);
    ...
    audioInfo["sample_rate"] = audioCodecParamsTLV[StreamController.AudioCodecParamTypes.SAMPLE_RATE].readUInt8(0);
...
StreamController.prototype._handleStopStream = function(callback) {
  var self = this;
...
StreamController.prototype._supportedAudioStreamConfiguration = function(audioParams) {
  ...
  var audioConfigurationsBuffer = Buffer(0);
  ...
  return Buffer.concat([audioConfigurationsBuffer, tlv.encode(0x02, 0x01)]).toString('base64');
}