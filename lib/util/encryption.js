...
module.exports = {
  generateCurve25519KeyPair: generateCurve25519KeyPair,
...
async function generateCurve25519KeyPair() {
  await sodium.ready;
  var keyPair = sodium.crypto_kx_keypair();
  return keyPair;
}

async function generateCurve25519SharedSecKey(priKey, pubKey) {
  await sodium.ready;
  var sharedSec = sodium.crypto_scalarmult(priKey, pubKey);
  return sharedSec;
}
