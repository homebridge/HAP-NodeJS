...
Accessory.prototype._handleGetCharacteristics = function(data, events, callback, remote) {
...
Accessory.prototype._handleSetCharacteristics = function(data, events, callback, remote) {
...
Accessory.prototype._handleResource = function(data, callback) {
  if (this.cameraSource) {
    this.cameraSource.handleResourceRequest(data, callback);
  } else {
