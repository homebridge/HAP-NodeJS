...
Accessory.prototype.publish = function(info, allowInsecureRequest) {
  ...
  //Removing the need to add the category in the implementation process 
  //if the accessory is Bridge. This makes the implementation a lot 
  //easier and also remove the need to "var Accessory = require('./').Accessory;"
  if (this._isBridge) {
    this._accessoryInfo.category = Accessory.Categories.BRIDGE;
  }
