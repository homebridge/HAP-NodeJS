...
function loadDirectory(dir) {
  ...
  return accessories.filter(function(accessory) {
    if(accessory === null || accessory === undefined || !accessory.length) { //check if accessory is not empty
      console.log("Invalid accessory!");
      return false;
    } else return (accessory instanceof Accessory) ? accessory : parseAccessoryJSON(accessory);
  });
}
