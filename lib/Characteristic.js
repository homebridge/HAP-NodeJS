...
Characteristic.prototype.toHAP = function(opt) {
  ...
  // extra properties
  if (this.props.unit != null) hap.unit = this.unit;
  if (this.props.maxValue != null) hap.maxValue = this.maxValue;
  if (this.props.minValue != null) hap.minValue = this.minValue;
  if (this.props.minStep != null) hap.minStep = this.minStep;
