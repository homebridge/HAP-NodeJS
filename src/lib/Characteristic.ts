    ...
    case Formats.UINT64: {
      ...
      if (this.props.validValueRanges && this.props.validValueRanges.length === 2) {
        if (value < this.props.validValueRanges[0]) {
          ...
          ${this.props.validValueRanges}, supplying illegal values will throw errors in the future`, characteristicWarningType);
    ...
    case Formats.STRING: {
      if (typeof value === "number") {
        this.characteristicWarning("characteristic was supplied illegal value: number instead of string, " +
          "supplying illegal values will throw errors in the future", characteristicWarningType);
        value = String(value);
      }
      if (typeof value !== "string") {
      ...
      if (value.length <= 1 && (this.UUID === Characteristic.Model.UUID || this.UUID === Characteristic.SerialNumber.UUID)) {
        ...
        HomeKit will reject this accessory, ignoring new value`, characteristicWarningType);
