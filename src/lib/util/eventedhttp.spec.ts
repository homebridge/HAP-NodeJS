...
import type { HAPConnection } from './eventedhttp'
...
import { HAPHTTPCode } from '../HAPServer.js'
...
describe('eventedhttp', () => {
  ...
  it('ensure connection handling respects nature of unpair', async () => {
