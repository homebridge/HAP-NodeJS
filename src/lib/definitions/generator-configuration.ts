import type { GeneratedCharacteristic, GeneratedService } from './generate-definitions'

import assert from 'node:assert'

import { Access } from '../Characteristic.js'
...
export const CharacteristicValidValuesOverride: Map<string, Record<string, string>> = new Map([
  ...
  ['input-source-type', { 0: 'Other', 1: 'Home Screen', 2: 'Tuner', 3: 'HDMI', 4: 'Composite Video', 5: 'S Video', 6: 'Component Video', 7: 'DVI', 8: 'AirPlay', 9: 'USB', 10: 'Application' }],
  ...
  ['remote-key', { 0: 'Rewind', 1: 'Fast Forward', 2: 'Next Track', 3: 'Previous Track', 4: 'Arrow Up', 5: 'Arrow Down', 6: 'Arrow Left', 7: 'Arrow Right', 8: 'Select', 9: 'Back', 10: 'Exit', 11: 'Play Pause', 15: 'Information' }],
