...
import { PairingStates, PairMethods, TLVValues } from '../internal-types.js'
import { chacha20_poly1305_decryptAndVerify, chacha20_poly1305_encryptAndSeal, HKDF } from '../lib/util/hapCrypto.js'
...
export class PairSetupClient {
  ...
  parseM2(m1Response: Buffer): PairSetupM2 {
    const objectsM2 = decode(m1Response)
  ...
  sendM3(m3: PairSetupM3): Promise<AxiosResponse<Buffer>> {
    return axios.post(
      ...
      encode(
        ...
        m3.srpClient.computeA(),
        TLVValues.PASSWORD_PROOF,
        m3.srpClient.computeM1(),
      ),
      { httpAgent: this.httpAgent, responseType: 'arraybuffer' },
    )
  }
  ...
  parseM4(m3Response: Buffer, m3: PairSetupM3): PairSetupM4 {
    const objectsM4 = decode(m3Response)
  ...
  sendM5(m5: PairSetupM5): Promise<AxiosResponse<Buffer>> {
    return axios.post(
      ...
      encode(
        ...
        Buffer.concat([m5.encryptedData.ciphertext, m5.encryptedData.authTag]),
      ),
      { httpAgent: this.httpAgent, responseType: 'arraybuffer' },
    )
  }
  ...
  parseM6(responseM5: Buffer, m4: PairSetupM4, m5: PairSetupM5): PairSetupM6 {
    const objectsM6 = decode(responseM5)
    ...
    expect(() => plaintextM6 = chacha20_poly1305_decryptAndVerify(
      m5.sessionKey,
    ...
    const subTLV_M6 = decode(plaintextM6)
