...
var execute = function(accessory,lightID,characteristic,value) {
	...
	if(characteristic === "identify") {
		...
		path = "/api/states/" + lightID;
		body = {state: "on", attributes: {brightness: value} };
	}
...
var ha_light = function(functionality, entity_id, value){
	// debug only
	console.log("ha_light " + entity_id + " " + functionality + ": " + value); 
};
